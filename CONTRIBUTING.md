...
# Contributing to ravenassetjs-lib
...
To contribute a patch, the workflow is as follows:
  ...
  1. Submit a pull request to https://github.com/npq7721/ravenassetjs-lib
...
- `bitcoinjs.script.compile` will try to adhere to bitcoin-core `IsStandard` policies rules. (eg. minimalpush in https://github.com/npq7721/ravenassetjs-lib/pull/638)
